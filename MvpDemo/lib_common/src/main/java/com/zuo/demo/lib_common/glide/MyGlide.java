...
public class MyGlide {
    ...
    public static void disPlayDetails(Context context, Object object, ImageView imageView, RequestOptions requestOptions, @Nullable RequestListener requestListener, @NonNull TransitionOptions transitionOptions) {
